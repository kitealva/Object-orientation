...
favoriteThings.candy = 'Chocolate'
...
let carl = new Cat('Carl', 3, 'black')
console.log(carl.name)
let steve = new Cat('Steve', 4, 'brown')
...
const dan = new Wizard('Dan', 21, 'Fire Breathing')
dan.castSpell()
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
//Code Here
let phoneOne = new Phone ('Samsung', 'S20 Ultra', 512, 'Black', 1000)
let phoneTwo = new Phone ('Apple', 'I Phone 12', 512, 'Grey', 1200)
let phoneThree = new Phone ('Google', 'Pixel 9', 512, 'White', 900)
/* 
...
//Code Here
const myFirstVehicle = new Vehicle(2, 'black', 0)
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(2, 'black', 0, 'Honda', true)
/*
...
//Code Here
const myFirstBoat = new Boat(12, 'black', 10000, 'Boat 12', 'yacht', false)
/*
